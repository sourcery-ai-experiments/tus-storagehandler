...
def upload_file():
    ...
    for uploaded_file in uploaded_files:
        ...
        if file_content:
            ...
            success_responses.append({'filename': filename, 'message': 'File uploaded successfully', 'Location': location})
        else:
            error_responses.append({'filename': filename, 'error': 'No file content provided'})
