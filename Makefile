...
help:
	...
	@echo "  \033[1m\033[35minstall\033[0m \033[37m(i)\033[0m: \033[36mInstall dependencies and TusStorageHandler.\033[0m"
...
docs:
	...
	@sphinx-apidoc -f -o docs/source/pages TusStorageHandler
	@cd docs && make html
	@echo "\nSummary ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n"
...
security:
	...
	@bandit -c pyproject.toml -r TusStorageHandler
